...
h.load_file('models/biophys_HL5PN1' + agegroup + '1.hoc')
...
def generateSubPop(popsize,mname,popargs,Gou,Gtonic,GtonicApic):
	...
	for cellind in range(0,len(network.populations[mname].cells)):
		if mname=='HL5PN1': h.load_file('models/biophys_HL5PN1' + agegroup + str(np.random.randint(1,high=31)) + '.hoc') # randomly sample a model
